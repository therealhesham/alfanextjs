...
const statusMap: Record<string, quote_status_enum> = {
  ...
  "سداد الدفعة الثانية": quote_status_enum.SECOND_PAYMENT,
  "طلب مواد المرحلة الثانية": quote_status_enum.PHASE_2_MATERIAL_ORDER,
  "تسليم مواد المرحلة الثانية": quote_status_enum.PHASE_2_MATERIAL_DELIVERY,
  "استلام مواد المرحلة الثانية": quote_status_enum.PHASE_2_MATERIAL_RECEIPT,
  "محضر استلام المرحلة الثانية": quote_status_enum.PHASE_2_RECEIPT_PROTOCOL,
  "سداد الدفعة الثالثة": quote_status_enum.THIRD_PAYMENT,
  "طلب مواد المرحلة الثالثة": quote_status_enum.PHASE_3_MATERIAL_ORDER,
  "تسليم مواد المرحلة الثالثة": quote_status_enum.PHASE_3_MATERIAL_DELIVERY,
  "استلام مواد المرحلة الثالثة": quote_status_enum.PHASE_3_MATERIAL_RECEIPT,
  "محضر استلام المرحلة الثالثة": quote_status_enum.PHASE_3_RECEIPT_PROTOCOL,
  "سداد الدفعة الرابعة": quote_status_enum.FOURTH_PAYMENT,
  "طلب مواد المرحلة الرابعة": quote_status_enum.PHASE_4_MATERIAL_ORDER,
  "تسليم مواد المرحلة الرابعة": quote_status_enum.PHASE_4_MATERIAL_DELIVERY,
  "استلام مواد المرحلة الرابعة": quote_status_enum.PHASE_4_MATERIAL_RECEIPT,
  "محضر استلام المرحلة الرابعة": quote_status_enum.PHASE_4_RECEIPT_PROTOCOL,
  "صيانة الضمان": quote_status_enum.WARRANTY_MAINTENANCE,
...
const reverseMap: Record<quote_status_enum, string> = {
  ...
  [quote_status_enum.SECOND_PAYMENT]: "سداد الدفعة الثانية",
  [quote_status_enum.PHASE_2_MATERIAL_ORDER]: "طلب مواد المرحلة الثانية",
  [quote_status_enum.PHASE_2_MATERIAL_DELIVERY]: "تسليم مواد المرحلة الثانية",
  [quote_status_enum.PHASE_2_MATERIAL_RECEIPT]: "استلام مواد المرحلة الثانية",
  [quote_status_enum.PHASE_2_RECEIPT_PROTOCOL]: "محضر استلام المرحلة الثانية",
  [quote_status_enum.THIRD_PAYMENT]: "سداد الدفعة الثالثة",
  [quote_status_enum.PHASE_3_MATERIAL_ORDER]: "طلب مواد المرحلة الثالثة",
  [quote_status_enum.PHASE_3_MATERIAL_DELIVERY]: "تسليم مواد المرحلة الثالثة",
  [quote_status_enum.PHASE_3_MATERIAL_RECEIPT]: "استلام مواد المرحلة الثالثة",
  [quote_status_enum.PHASE_3_RECEIPT_PROTOCOL]: "محضر استلام المرحلة الثالثة",
  [quote_status_enum.FOURTH_PAYMENT]: "سداد الدفعة الرابعة",
  [quote_status_enum.PHASE_4_MATERIAL_ORDER]: "طلب مواد المرحلة الرابعة",
  [quote_status_enum.PHASE_4_MATERIAL_DELIVERY]: "تسليم مواد المرحلة الرابعة",
  [quote_status_enum.PHASE_4_MATERIAL_RECEIPT]: "استلام مواد المرحلة الرابعة",
  [quote_status_enum.PHASE_4_RECEIPT_PROTOCOL]: "محضر استلام المرحلة الرابعة",
  [quote_status_enum.WARRANTY_MAINTENANCE]: "صيانة الضمان",
